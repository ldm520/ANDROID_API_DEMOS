 ...
 */
/**
 * TaskBackService——这个服务是基于在Android 4.0(API级别14)中引入的增强了的辅助性API。然而,你可以使用Android
 * Support Libary代替之后API中引入的类 (例如AccessibilityRecord, AccessibilityNodeInfo )
 * 与等效支持包类 (例如 AccessibilityRecordCompat, AccessibilityNodeInfoCompat
 * )，使得这个例子可以使用在Android 1.6(API 4)的版本上。
 * 
 * @description：
 * @author ldm
 * @date 2016-5-6 上午9:52:40
 */
public class TaskBackService extends AccessibilityService implements
	...
	public void onServiceConnected() {
		// Initializes the Text-To-Speech engine as soon as the service is
		// connected.
	...
	public void onAccessibilityEvent(AccessibilityEvent event) {
		...
		//
		// NOTE: Every method that returns an AccessibilityNodeInfo may return
		// null,
		...
		// Using this parent, get references to both child nodes, the label and
		// the checkbox.
		...
		String taskStr = getString(R.string.task_complete_template, taskLabel,
				completeStr);
	...
	private AccessibilityNodeInfo getListItemNodeInfo(
