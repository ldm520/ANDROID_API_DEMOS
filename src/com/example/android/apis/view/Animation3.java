...
public class Animation3 extends Activity implements
	...
	public void onItemSelected(AdapterView<?> parent, View v, int position,
		...
		a.setDuration(1000);// 设置动画时长
		a.setStartOffset(300);// 设置动画启动时间
		a.setRepeatMode(Animation.RESTART);// 设置重复模式
		a.setRepeatCount(Animation.INFINITE);// 设置重复次数

		switch (position) {// 根据item选择设置对应的动画 插值器
		case 0:
