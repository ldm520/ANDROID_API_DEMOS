...
public class LayoutAnimationsHideShow extends Activity {
    ...
    private static final String TAG = LayoutAnimationsHideShow.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            newButton.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
    ...
    private void setupCustomAnimations() {
        ...
        PropertyValuesHolder pvhLeft =
                PropertyValuesHolder.ofInt("left", 1, 0);
        PropertyValuesHolder pvhTop =
                PropertyValuesHolder.ofInt("top", 1, 0);
        PropertyValuesHolder pvhRight =
                PropertyValuesHolder.ofInt("right", 1, 0);
        PropertyValuesHolder pvhBottom =
                PropertyValuesHolder.ofInt("bottom", 1, 0);
        PropertyValuesHolder pvhScaleX =
                PropertyValuesHolder.ofFloat("scaleX", 1f, 0f, 1f);
        PropertyValuesHolder pvhScaleY =
                PropertyValuesHolder.ofFloat("scaleY", 1f, 0f, 1f);
        final ObjectAnimator changeIn = ObjectAnimator.ofPropertyValuesHolder(
                        new Object(), pvhLeft, pvhTop, pvhRight, pvhBottom, pvhScaleX, pvhScaleY).
