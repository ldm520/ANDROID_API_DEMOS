 ...
 */
/**
 * API动画效果之：Property Animation 属性动画
 * 
 * @description：Property Animation动画产生于安卓3.0及之后 ，原理是利用了View所拥有的属性，进行一系列的操作。
 *                       它不仅改变View的绘制，也改变了View的属性；这是优于Tween Animation之处。
 * @author ldm
 * @date 2016-5-9 上午10:12:01
 */
public class MultiPropertyAnimation extends Activity {
	...
	public class MyAnimationView extends View implements
		...
		// AnimatorSet属性动画的集合，可以添加下面的值动画和对象对象在其内，可同时运行或顺序运行
